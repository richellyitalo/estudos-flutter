  ...
  void didChangeDependencies() {
    ...
    if (_formData.isEmpty) {
      ...
      if (product != null) {
        ...
        _formData['price'] = '';
        _formData['price'] = '35.55';
        _formData['title'] = 'teste produto';
        _formData['description'] = 'pofijasdpof ijasdpofijsd';
        _formData['imageUrl'] =
            'https://miro.medium.com/max/3840/1*ux4nrZueb_1h-QVMF8S2Aw.jpeg';
        _imageUrlController.text = _formData['imageUrl'];
      }
    }
  }
